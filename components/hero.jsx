  ...
  return (
    <section className="sm:px-0 lg:px-0">
      <div
        ...
        style={{
          backgroundImage:
            `linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url("/computer.jpg")`,
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-black font-serif mb-12 max-w-3xl mx-auto">
          ...
          {/* Upload Area */}
          <div className="bg-gray-300 rounded-lg shadow-lg p-8 mb-12 border-2 border-dashed border-gray-300 hover:border-gray-900 transition-colors cursor-pointer">
            <div className="flex flex-col items-center">
              <Upload className="h-16 w-16 text-gray-700 mb-4" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-800">Select your PDF files from your device</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-gray-300 rounded-full p-4 mb-4">
              ...
              <p className="text-gray-800">Choose your conversion or editing tool</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-gray-300 rounded-full p-4 mb-4">
              ...
              <p className="text-gray-800">Get your processed file instantly</p>
            </div>
          </div>
        </div>
      </div>
