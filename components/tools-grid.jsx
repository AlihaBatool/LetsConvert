...
export function ToolsGrid() {
  return (
    <section className="py-16 px-4 bg-gray-100 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">All the tools you'll need</h2>
          <p className="text-lg text-gray-800">Choose from our comprehensive suite of PDF tools</p>
        </div>
